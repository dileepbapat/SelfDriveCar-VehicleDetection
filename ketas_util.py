...
def find_cars(img, ystart, ystop, xstart, xstop, scale, model, X_scaler, orient, pix_per_cell, cell_per_block, spatial_size, hist_bins):
...
def pipeline_keras(image):
    scale=1.5
    boxes = find_cars(image, 400, 670, 0, 1280, scale, model, X_scaler, orient, pix_per_cell, cell_per_block, spatial_size, hist_bins)
    scale=2
    boxes.extend(find_cars(image, 400, 670, 0, 1280, scale, model, X_scaler, orient, pix_per_cell, cell_per_block, spatial_size, hist_bins))
    print boxes
...
white_clip = clip1.fl_image(pipeline_keras) #NOTE: this function expects color images!!
